...
public class Cubo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese el valor de la diagonal del cubo");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(20, 20, 261, 23);

        campoArista.setFont(new java.awt.Font("MV Boli", 0, 14)); // NOI18N
        campoArista.setForeground(new java.awt.Color(0, 153, 255));
        getContentPane().add(campoArista);
        campoArista.setBounds(20, 60, 144, 29);
        ...
        limpiar.setBounds(20, 310, 140, 31);
        ...
        MenuPrincipal.setBounds(300, 310, 140, 31);

        jLabel1.setFont(new java.awt.Font("MV Boli", 0, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 102, 204));
        jLabel1.setText("El resultado del volumen del cubo es");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(190, 180, 260, 23);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/IMG-20180315-WA0061.jpg"))); // NOI18N
        jLabel5.setText("imagen");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(-290, -50, 830, 480);

        pack();
    }// </editor-fold>//GEN-END:initComponents
      double diagonal, arista, volumenCubo;
    private void ejecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ejecutarActionPerformed
        
        diagonal = Double.parseDouble(campoArista.getText());
        arista = diagonal / (Math.sqrt(3));
        
        volumenCubo = Math.pow(arista, 3);
        
        resultado.setText("" + volumenCubo);
